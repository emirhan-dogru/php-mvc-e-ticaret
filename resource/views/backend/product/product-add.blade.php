                ...
                <div class="bg-white p-4 border rounded shadow">
                        <form action="{{base_url("admin/product-add")}}" method="POST"  enctype="multipart/form-data"  class="row" >
                                ...
                                <div class="form-group col-md-6">
                                        ...
                                        <input type="number" value="0" step="0.01" min="0" max="999999" class="form-control" placeholder="Product Price" required name="product_price" >
                                </div>

                                <div class="form-group col-md-6">
                                        <label>Discounted Price of the Product  <small>If there is no discount, write (0)</small> </label>
                                        <input type="number" value="0" step="0.01" min="0" max="999999" class="form-control" placeholder="Product price" required name="product_sale_price" >
                                </div>

                                <div class="form-group col-md-6">
                                        <label>Product Stock Number</label>
                                        <input type="number" value="0" step="1" min="0" max="999999" class="form-control" placeholder="Product Stock Number" required name="product_stock" >
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                        ...
                                        <textarea name="product_description" placeholder="Product Description" class="form-control" rows="5"></textarea>
                                </div>
                                <div class="col-md-12">
...
<div class="col-md-12">
        <button class="btn btn-dark mb-3" type="button" id="btnAddVariant">Add Variant</button>
</div>
    ...
    <script>
            ...
            $('#btnAddVariant').click(function(){
                ...
                let variantInput = ` <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" placeholder="Variant Value" class="form-control" name="product_variant_value[values_${variantCount}][]" >
                                                </div>`;
                ...
                let html = `<div class="col-md-12 p-2 border bg-light rounded mb-4">
                                        <div class="row">
                                                <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" placeholder="Variant Name" class="form-control" name="product_variant_name[names_${variantCount}]" >
                                                </div>

                                               <div class="col-md-12">
                                                <div class="row variantItemArea" data-count="${variantCount}">
                                                ${variantInput} 
                                                <button class="btn btn-primary btn-sm variantAddBtn" type="button"> Add New</button>
                                                </div>
                                               </div>
                                        </div>
                                </div>`;
